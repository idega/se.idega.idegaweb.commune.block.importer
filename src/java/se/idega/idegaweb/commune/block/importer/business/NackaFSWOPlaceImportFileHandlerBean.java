 ...
 * insert into im_handler values(6, 'Nacka FS without place, Childcare queue importer', 
 * 'se.idega.idegaweb.commune.block.importer.business.NackaFSWOPlaceImportFileHandlerBean',
 * 'Imports the FS without place Childcare queue in Nacka.')<br>
