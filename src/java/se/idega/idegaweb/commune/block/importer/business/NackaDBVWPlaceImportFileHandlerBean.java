 ...
 * insert into im_handler values(4, 'Nacka DBV with place Childcare queue importer', 
 * 'se.idega.idegaweb.commune.block.importer.business.NackaDBVWPlaceImportFileHandlerBean',
 * 'Imports the DBV with place Childcare queue in Nacka.')<br>
