...
//	private Gender male;
	...
	public boolean handleRecords() {
		...
		this.schoolTypeID = Integer.parseInt(bundle.getProperty("child_care_school_type", "2"));
		this.count = 0;
		this.failCount = 0;
		this.successCount = 0;
...
//		report.append("School cls member not found creating...");
		...
		try {
			...
			boolean importDone = cc.importChildToProvider(-1, ((Integer)child.getPrimaryKey()).intValue(), schoolID, classID, hours, -1, this.schoolTypeID, null, sDateT, placementTo,
